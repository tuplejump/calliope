...
import org.apache.hadoop.hive.ql.processors.{CommandProcessor, CommandProcessorFactory, SetProcessor}
import org.apache.hadoop.hive.ql.session.SessionState
import org.apache.hadoop.hive.shims.ShimLoader
import org.apache.spark.Logging
import org.apache.spark.sql.hive.CalliopeSQLDriver
import org.apache.thrift.transport.TSocket

import scala.collection.JavaConversions._

object CalliopeCLIDriver {
    ...
    HiveInterruptUtils.add(new HiveInterruptCallback {
      override def interrupt() {
        ...
        if (CalliopeSQLEnv.sparkContext != null) {
          CalliopeSQLEnv.sparkContext.cancelAllJobs()
        } else {
          if (transport != null) {
...
class CalliopeCLIDriver extends CliDriver with Logging {
